...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsForHotel([Description("ID of the hotel")] int hotelId)
    {
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("ID of the hotel")] int hotelId, [Description("Date")] DateTime dt)
    {
